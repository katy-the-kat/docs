...
<ul class="pl-5 list-disc">
    ...
    <li>Provider that utilizes pirated software (ex. "nulled" WHMCS and other software)</li>
    <li>Provider that violates other projects rights (ex. selling licensed software without authorization)</li>
...
| [ConquerHost](https://conquerhost.xyz) | Unauthorized GSP selling FiveM servers |
