...
| [Evix Datacenter](https://evix-datacenter.online) | No publicly available Privacy Policy & SLA, official account threatening to DDoS people ([1](https://onlinefile.host/lkn5vtl), [2](https://onlinefile.host/54owa1o), [3](https://onlinefile.host/flsgxnu), [4](https://onlinefile.host/x0omgfm), [5](https://onlinefile.host/mdp5sul)), official discord account using slurs ([1](https://onlinefile.host/fenwcql), [2](https://onlinefile.host/7p9co2m)) |
...
| [LunX](https://lunx.host/) | Fallback company made by ZTX and Paladin owners, the companies lost data several times had their nodes suspended. |
| [Springracks](https://springracks.com) | Obstructive Terms of Service that disallows `running any task that will completely cap out the CPU limit set on your service` (What if there's just high load on your Minecraft server? Who knows!) |
| [EmpireNodes](https://empirenodes.com) | No Privacy Policy, Terms of Service that disallows `"Saying we are using fake ram"`, `Beg for new nodes` |
