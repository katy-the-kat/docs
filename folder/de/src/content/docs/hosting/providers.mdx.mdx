...
The setup.md sponsored MCHO.ST is a great place for those looking for a server that wont break the bank, with both an invite-2-play and a traditional pay-2-play model anyone can create a Minecraft server for them and their friends.
...
<ul class="pl-5 list-disc">
    <li>Invite-2-Play: Free</li>
    <li>Pay-2-Play: €4.99/month</li>
</ul>
...
<ul class="pl-5 list-disc">
    <li>Locations: Coventry, Gravelines, Hillsboro, Montreal, Roubaix, Sydney</li>
</ul>
...
<ul class="pl-5 list-disc">
    <li>Budget: $1/GB/month</li>
    <li>Premium: $2.25/GB/month</li>
    <li>Extreme: $2/GB/month (Min Order 6GB / 3 Threads)</li>
</ul>

<LinkCard
  title="Website"
  href="https://pebblehost.com"
/>
