...
<ul class="pl-5 list-disc">
    <li>Proxies such as BungeeCord and Velocity which require backend servers to have online mode disabled - the proxy must have online mode enabled for this to count</li>
    <li>Offline local-hosted environments which lack internet access, assuming everyone owns a Minecraft account otherwise</li>
    <li>Local-hosted development servers for testing plugins and mods</li>
</ul>
